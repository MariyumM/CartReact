...
const CheckoutPage = () => {
  ...
  const handleDownloadReceipt = () => {
    ...
    html2canvas(input).then((canvas) => {
      ...
      const ratio = Math.min(pdfWidth / imgWidth, pdfHeight / imgHeight); // Fix the ratio calculation
  ...
  return (
    <>
      ...
      <div className="checkout-page bg-white min-h-screen p-6 h-[356px]  ">
        ...
        <div className="w-[350px] h-1350 absolute top-16294 left-56636 bg-white mt-6 p-6 border border-gray-400">
          <div id="receipt">
